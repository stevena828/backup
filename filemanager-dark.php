...
$auth_users = array(
    'matamutol!0979' => '$2y$10$DD/a3tVFlGbds7NT/UKnX.Kzv0x5uFhW8ddEeaFjiREHOs67whx6m', 
);
...
$root_path = '/var/www/heboh-sendiri/public_html';
...
.context-menu-item:hover {
 ...
 body.fm-login-page {
  ...
  <style>
    body { background-color: #1e1e1e !important; color: #eee !important; }
    .navbar { background-color: #151515 !important; color: #fff !important; }
    .navbar .navbar-brand { color: #fff !important; }
    #filetree, .sidebar { background: #2a2a2a !important; color: #ccc !important; }
    .table { background: #2f2f2f !important; color: #eee !important; }
    .table-hover tbody tr:hover { background-color: #3a3a3a !important; }
    .breadcrumb { background-color: #333 !important; color: #ccc !important; }
    .context-menu-list { background-color: #2f2f2f !important; }
    .context-menu-item { color: #ddd !important; }
    .context-menu-item:hover { background-color: #444 !important; color: #fff !important; }
  </style>
            ...
            <script>
                ...
                function renderThemeMode() {
                    ...
                    if (_data && _data.aceTheme) {
                        var lightTheme = optionNode("ace/theme/", _data.aceTheme.dark),
